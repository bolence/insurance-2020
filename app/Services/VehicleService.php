...
class VehicleService {
    ...
    public function save($request)
    {
        ...
        try
        {
            ...
            // save kasko for vehicle - not for now
            // $vehicle->kasko()->save( $this->kasko_data( $request) );
    ...
    public function update( $request, $id)
    {
        ...
        $vehicle_request = $request->only('name','reg_broj','name','reg_broj','ks','inv_broj','broj_sasije','broj_motora','godina_proizvodnje','ks','broj_sedista','radna_zapremina','dozvoljena_nosivost');
