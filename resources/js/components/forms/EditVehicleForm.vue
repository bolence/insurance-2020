    ...
    <hr class="fancy">
     ...
     <div class="j-row">
        ...
        <div class="j-span3 j-unit">
            ...
            <select name="os_drustvo" v-model="vehicle.os_drustvo">
        ...
        <div class="j-span3 j-unit">
            ...
            <input type="text" placeholder="Broj polise" id="broj_polise" name="broj_polise" v-model="vehicle.broj_polise">
        ...
        <div class="j-span3 j-unit">
            ...
            <input type="text" placeholder="Visina premije" id="visina_premije" name="visina_premije" v-model="vehicle.visina_premije">
        ...
        <div class="j-span3 j-unit">
            ...
            <datepicker v-model="vehicle.datum_isticanja_osiguranja" name="datum_isticanja_osiguranja" format="dd MMM yyyy" :language="sr" input-class="form-control" calendar-button-icon="fa fa-calendar"></datepicker>
